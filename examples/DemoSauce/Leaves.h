...
public:
	...
	void init( HX8357_t3n tft );
	uint_fast16_t bgColor( void );
	String title();
	void perFrame( HX8357_t3n tft, FrameParams frameParams );

private:
  void _drawLeaves( HX8357_t3n tft, boolean doErase, uint_fast8_t iter, float radius, float spin, float x, float y, uint_fast16_t solidColor, uint_fast16_t outlineColor );

  float _phase = 0;
  uint_fast16_t _bgColor;
};

void Leaves::init( HX8357_t3n tft ) {
  _bgColor = 0x780f;
}
...
void Leaves::_drawLeaves( HX8357_t3n tft, boolean doErase, uint_fast8_t iter, float radius, float spin, float x, float y, uint_fast16_t solidColor, uint_fast16_t outlineColor ) {
...
void Leaves::perFrame( HX8357_t3n tft, FrameParams frameParams ) {
