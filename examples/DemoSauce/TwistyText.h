...
void TwistyText::init( HX8357_t3n tft ) {
...
void TwistyText::reset( HX8357_t3n tft ) {
...
void TwistyText::perFrame( HX8357_t3n tft, FrameParams frameParams ) {
