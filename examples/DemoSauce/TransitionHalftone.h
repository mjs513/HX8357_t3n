...
public:
  ...
  void init( HX8357_t3n tft );
	void restart( HX8357_t3n tft, uint_fast16_t color );
...
void TransitionHalftone::init( HX8357_t3n tft ) {

}

void TransitionHalftone::restart( HX8357_t3n tft, uint_fast16_t inColor ) {
...
void TransitionHalftone::perFrame( HX8357_t3n tft, FrameParams frameParams ) {
