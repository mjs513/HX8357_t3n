...
void TransitionDither::init( HX8357_t3n tft ) {

}

void TransitionDither::restart( HX8357_t3n tft, uint_fast16_t inColor ) {
...
void TransitionDither::perFrame( HX8357_t3n tft, FrameParams frameParams ) {
