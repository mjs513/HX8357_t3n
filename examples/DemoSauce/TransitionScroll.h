...
void TransitionScroll::init( HX8357_t3n tft ) {
	_pixels = (uint16_t*)malloc( sizeof(uint_fast16_t) * tft.width() );
}

void TransitionScroll::restart( HX8357_t3n tft, uint_fast16_t inColor ) {
...
void TransitionScroll::perFrame( HX8357_t3n tft, FrameParams frameParams ) {
