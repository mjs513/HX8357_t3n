...
void TransitionSquares::init( HX8357_t3n tft ) {

}

void TransitionSquares::restart( HX8357_t3n tft, uint_fast16_t inColor ) {
...
void TransitionSquares::perFrame( HX8357_t3n tft, FrameParams frameParams ) {
