...
private:
  void _drawLine( HX8357_t3n tft, float cosTilt, float sinTilt, float x, float y, float z, uint_fast16_t w_2, uint_fast16_t h_2, uint_fast16_t color );
...
void Sphere3D::init( HX8357_t3n tft ) {
...
void Sphere3D::_drawLine( HX8357_t3n tft, float cosTilt, float sinTilt, float x, float y, float z, uint_fast16_t w_2, uint_fast16_t h_2, uint_fast16_t color ) {
  // Tilt!
  float tempY = y;
...
void Sphere3D::perFrame( HX8357_t3n tft, FrameParams frameParams ) {
