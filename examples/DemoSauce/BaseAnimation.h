...
public:
	...
	virtual void reset( HX8357_t3n tft );
...
void BaseAnimation::init( HX8357_t3n tft ) {
	// Extend me
}
...
void BaseAnimation::reset( HX8357_t3n tft ) {
	// Extend me
}
...
void BaseAnimation::perFrame( HX8357_t3n tft, FrameParams frameParams ) {
	// Extend me
}
